...
public class MonsterPlayer2 extends Player {
	...
	public MonsterPlayer2(Stage stage) {
		super(stage);
		setSpriteNames( new String[] {"PacmanGhost2.png"});
  ...
  public void keyReleased(KeyEvent e) {
   	switch (e.getKeyCode()) {
  		case KeyEvent.VK_K : down = false;break;
		  case KeyEvent.VK_I : up = false; break;
		  case KeyEvent.VK_J : left = false; break; 
		  case KeyEvent.VK_L : right = false;break;
   	}
   	updateSpeed();
  }
  ...
  public void keyPressed(KeyEvent e) {
  	switch (e.getKeyCode()) {
		  case KeyEvent.VK_I : up = true; break;
		  case KeyEvent.VK_J : left = true; break;
		  case KeyEvent.VK_L : right = true; break;
		  case KeyEvent.VK_K : down = true;break;
