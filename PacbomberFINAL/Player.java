...
public class Player extends Actor {
	public static final int MAX_SHIELDS = 750;
	...
	public Player(Stage stage) {
		super(stage);
		setSpriteNames( new String[] {"Pacman.png"});
  ...
  public void keyPressed(KeyEvent e) {
  	switch (e.getKeyCode()) {
		  case KeyEvent.VK_UP : up = true;
		  	setSpriteNames( new String[] {"PacmanUP.png"}); break;
		  case KeyEvent.VK_LEFT : left = true;
		   	setSpriteNames( new String[] {"PacmanLEFT.png"}); break;
		  case KeyEvent.VK_RIGHT : right = true;
		  	setSpriteNames( new String[] {"Pacman.png"}); break;
		  case KeyEvent.VK_DOWN : down = true;
		  	setSpriteNames( new String[] {"PacmanDOWN.png"}); break;
		  //case KeyEvent.VK_SPACE : fire(); break;
		  case KeyEvent.VK_ENTER : fireCluster (); break;
  	}
  	updateSpeed();
  }
...
public void fireCluster() {
	...
	//  stage.addActor( new Bomb(stage, Bomb.UP_MID_RIGHT,x,y));
//	  stage.addActor( new Bomb(stage, Bomb.UP_MID_LEFT,x,y));
	//  stage.addActor( new Bomb(stage, Bomb.UP_MID_MID_RIGHT,x,y));
	//  stage.addActor( new Bomb (stage, Bomb.UP_MID_MID_LEFT,x,y));
...
//	  stage.addActor( new Bomb(stage, Bomb.DOWN_RIGHT,x,y));
  ...
  public void addScore(int i) { score += i;  }
	...
	public void collision(Actor a) {
		...
		if (a instanceof MonsterPlayer2 ) {
		  setPrevX(388);
		  setPrevY(401);
		  shields--;
		  setSpriteNames( new String[] {"Pacman.png"});
        ...
        if (a instanceof Dots ) {
          a.remove();
          score+=10;
          stage.getSoundCache().playSound("apert.wav");
        }
        if (a instanceof Dots2 ) {
          a.remove();
          score+=10;
          stage.getSoundCache().playSound("apert.wav");
          clusterBombs++;
